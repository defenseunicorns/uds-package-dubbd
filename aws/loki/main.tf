...
locals {
  ...
  generate_kms_key = var.kms_key_arn == null || var.kms_key_arn == "" ? 1 : 0
  kms_key_arn      = var.kms_key_arn == null || var.kms_key_arn == "" ? module.generate_kms[0].kms_key_arn : var.kms_key_arn
